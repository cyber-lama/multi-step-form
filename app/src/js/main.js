window.onload = function () {
    var form = {
        ...
        validateInput: function (button) {
            ...
            function checkAttributeName(item, value) {
                if (value.length < 2) {
            ...
            function checkAttributePhone(item, value) {
                if (value.length < 1) {
            ...
            function checkAttributeEmail(item, value) {
        ...
        createDiv: function () {
            ...
            let arraySpanGetCount = this.$el.find('span.count');
            ...
            if (arraySpanGetCount) {
                for (let i = 0; i < arraySpanGetCount.length; i++) {
                    let span = document.createElement('span');
                    span.innerHTML = ' ' + arraySpanGetCount.length;
                    arraySpanGetCount[i].after(span);
                }
